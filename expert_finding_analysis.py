...
This is a pilot benchmark. Publication claims require repeated seeds,
confidence intervals, and matched supervised baselines.
...
def word2vec_embeddings(walks, n, prefix='u'):
    ...
    # Gensim's multi-worker training is not deterministic even with a seed.
    model = Word2Vec(walks, vector_size=EMB_DIM, window=5, min_count=0,
                     sg=1, workers=1, epochs=3, seed=SEED)
