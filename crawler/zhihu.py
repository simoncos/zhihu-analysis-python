...
class Question:
    ...
    def get_title(self):
        if hasattr(self, "title"):
            return self.title# modification mark (nathanlvzs)
            ...
            self.title = title
            return title# modification mark (nathanlvzs)
            # if platform.system() == 'Windows':
    ...
    def get_detail(self):
        ...
        return detail# modification mark (nathanlvzs)
        # if platform.system() == 'Windows':
...
class User:
    ...
    def get_user_id(self):
        if self.user_url == None:
            ...
            return "匿名用户"# modification mark (nathanlvzs)
            # if platform.system() == 'Windows':
            ...
            if hasattr(self, "user_id"):
                return self.user_id# modification mark (nathanlvzs)
                # if platform.system() == 'Windows':
                ...
                self.user_id = user_id
                return user_id# modification mark (nathanlvzs)
                # if platform.system() == 'Windows':
